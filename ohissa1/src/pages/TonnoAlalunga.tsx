...
import PescaProduzione9 from "../assets/4-3bb5d4b6.png";
  ...
  return (
    <div className="app" style={{ minHeight: "100vh", width: "100vw", background: "#fff" }}>
      ...
      <main style={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "flex-start"}}>
        {/* Hero e info: visibili sia su desktop che mobile */}
        <img src={Group3_1} alt="Tonno Alalunga" style={{ width: "100vw", height: "auto", display: "block" }} />
        <section className="alalunga-hero" style={{ width: '100vw', background: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: isDesktop ? '48px 0' : '32px 0 18px 0', gap: isDesktop ? '32px' : '18px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: isDesktop ? '32px' : '18px', maxWidth: '900px', width: '100%', flexWrap: 'wrap', justifyContent: 'center' }}>
            <img src={Frame350_2} alt="Alalunga" style={{ width: isDesktop ? '260px' : '195px', height: isDesktop ? '240px' : '180px', objectFit: 'cover',}} />
        ...
        {/* PESCA & PRODUZIONE: visibile sia su desktop che mobile */}
        <section
          style={{
            width: "100vw",
...
{/* Sezione Tagli di Tonno Alalunga – FULL SCREEN */}
  ...
  >
    ...
    {[
      {
        img: Frame412_4, title: "TARTARE", reverse: false,
        text: "Il pesce crudo è rigorosamente tagliato al coltello in cubetti molto piccoli di grandezza non superiore al centimetro (una dadolata piccola e precisa) riassemblati in graziosi tortini."
      },
      {
        img: Frame412_5, title: "CARPACCIO", reverse: true,
        text: "Pesce crudo tagliato a fettine molto sottili, grazie all’uso di un coltello specifico. Lo spessore delle fettine è fondamentale per ottenere un’ottima marinatura."
      },
      {
        img: Frame412_6, title: "SAKU", reverse: false,
        text: "È la parte più nobile del filetto del pesce tagliata in un compatto blocchetto rifilato e senza pelle: un taglio leggermente spesso e morbidissimo."
      },
      {
        img: Frame412_7, title: "POKE", reverse: true,
        text: "Di origine hawaiana, il filetto del pesce è tagliato in cubetti: poke in hawaiano significa appunto “tagliare a pezzi”. È un taglio molto morbido e gustoso."
      }
    ].map((item, i) => (
      <div
        key={i}
      ...
      >
        ...
        >
          ...
          <p
            style={{
              fontSize: isDesktop ? "1.12rem" : "1.05rem",
              color: "#555",
              lineHeight: 1.65,
            }}
          >
