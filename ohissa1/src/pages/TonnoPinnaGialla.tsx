...
import tonnoCircle from "../assets/Frame 350 (8).png";          // tondo con cubetti
import pescaProduzione from "../assets/3-3bb5d4b6.png";
import tartareImg from "../assets/Frame 9 (4).png";
...
const TonnoPinnaGialla: React.FC = () => {
  // Simple desktop detection using window width
          ...
          >
            <div
              style={{
                ...
                height: isDesktop ? 30 : 260,
                
              }}
            >
              <img
                src={tonnoCircle}
                alt="Tonno a pinna gialla"
                style={{
                  width: "100%",
                  height: "100%",
                  objectFit: "cover",
            ...
            >
              ...
              >
               <p>
              Il tonno a pinna gialla ha una consistenza soda e un sapore
              delicato.
        
              Pesce dalle caratteristiche organolettiche eccellenti, contiene
              un notevole quantitativo di proteine ad alto valore biologico,
              di grassi essenziali ed Omega 3.
            
              È anche ricco di vitamine, quali B1, B2, B3, A, e tra i sali
              minerali spicca soprattutto il ferro.
            </p>
              </p>
              <p
                style={{
              ...
              </p><div className="tonno-intro-cert">
              <img src={MscLogo} alt="Certificazione MSC" />
            </div>
            </div>
          </div>
        </section>
...
{/* PESCA & PRODUZIONE */}
      ...
      {/* TAGLI – TARTARE / CARPACCIO / SAKU / POKE */}
  ...
  >
    ...
    >
      ...
      >
        ...
        >
          Pesce crudo tagliato a fettine molto sottili, grazie
          all’uso di un coltello specifico. Lo spessore delle
          fettine è di fondamentale importanza per ottenere
    ...
    >
      ...
      >
        ...
        >
          È la parte più nobile del filetto di pesce tagliata in un
